...
//   { text: "Digital", row: 1, col: 3 },
//   { text: "Design", row: 2, col: 1 },
//   { text: "Studio", row: 2, col: 3 },
//   { text: "Premium", row: 3, col: 1 },
//   { text: "Quality", row: 3, col: 3 },
//   { text: "Expert", row: 4, col: 1 },
//   { text: "Reliable", row: 4, col: 2 },
//   { text: "Secure", row: 4, col: 3 },
// ];
...
//   const currentGridItems = isMobile ? mobileGridItems : gridItems;
...
//             gap: "1px",
//             width: isMobile ? "95vw" : isTablet ? "90vw" : "min(100vw, 1500px)",
//             height: isMobile ? "70vh" : isTablet ? "75vh" : "min(80vh, 1200px)",
//             willChange: "transform",
//           }}
//         >
//           {currentGridItems.map((item, i) => (
//             <div
//               key={i}
...
//             >
//               <span
//                 className={`text-white/20 font-light tracking-[0.1em] sm:tracking-[0.15em] uppercase text-center px-1 sm:px-2 ${
//                   isMobile
//                     ? "text-[8px]"
//                     : isTablet
//                       ? "text-[9px]"
