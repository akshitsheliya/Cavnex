...
//       <div className="max-w-full mx-auto px-6  pb-0">
//         <motion.div
...
//           className="text-gray-400 text-sm sm:text-base max-w-2xl mb-16 sm:mb-20 leading-relaxed"
//         >
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-12 sm:gap-y-14 gap-x-8 lg:gap-x-12 pb-20 sm:pb-24">
...
//             >
//               <span
//                 className="text-5xl sm:text-6xl lg:text-7xl font-normal text-white leading-none flex-shrink-0"
...
//       <div
//         className="absolute bottom-0 right-0 w-72 h-72 sm:w-96 sm:h-96 pointer-events-none"
//         style={{
//           background:
//             "radial-gradient(ellipse at bottom right, rgba(16,185,129,0.35) 0%, rgba(99,102,241,0.2) 40%, transparent 70%)",
//           filter: "blur(30px)",
//         }}
//       />

//       <div className="relative bg-black border-t border-gray-900 mt-0">
...
//                 <img src={Vector_infinite} alt="" />

//                 <div className="absolute left-[8%] top-1/2 -translate-y-1/2 text-center">
//                   <p className="text-gray-400 text-xs sm:text-xl font-light leading-snug">
//                     Innovation Driven <br /> Development
//                   </p>
//                 </div>

//                 <div className="absolute right-[10%] top-1/2 -translate-y-1/2 text-center">
//                   <p className="text-gray-400 text-xs sm:text-xl font-light leading-snug">
//                     Turning Ideas <br /> into Tech
//                   </p>
//                 </div>
//               </div>
//             </motion.div>
...
//         <div
//           className="absolute bottom-0 right-0 w-64 h-64 sm:w-80 sm:h-80 pointer-events-none"
//           style={{
//             background:
//               "radial-gradient(ellipse at bottom right, rgba(99,102,241,0.3) 0%, rgba(16,185,129,0.15) 50%, transparent 70%)",
//             filter: "blur(40px)",
//           }}
//         />
//       </div>
...
//   );
// }
// src/components/home/ValueSection.jsx
