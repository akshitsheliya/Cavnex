...
//       <div ref={containerRef} className="relative w-full  pt-6">
//         <div
...
//                     opacity: isCardHovered ? 0.5 : undefined,
//                     animation: isCardHovered ? "none" : undefined,
//                   }}
//                 />
//               ))}
//             </div>
//             <span className="text-white/50 text-xs ml-1">
//               {isCardHovered ? "Scroll to navigate" : "Auto-scrolling"}
//             </span>
//           </div>
//         </div>
//       </div>
...
//       {/* <div
//         className="relative w-full overflow-hidden mt-10 sm:mt-14"
...
//         />
//         <div
//           className="absolute left-0 w-40 h-40 rounded-full pointer-events-none z-10"
//           style={{
//             background:
...
//           style={{ gap: "clamp(4px, 1vw, 12px)", paddingLeft: "2vw" }}
//         >
...
//             >
//               <span
//                 className="block text-transparent font-black leading-none select-none w-full text-center"
//                 style={{
