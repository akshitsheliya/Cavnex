    ...
    <div className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20">
      <div className="max-w-7xl mx-auto container-padding">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-4 sm:mb-6">
            {service.description}
          </p>
          <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-primary-600 to-purple-600 rounded-full text-white font-semibold text-sm sm:text-base">
